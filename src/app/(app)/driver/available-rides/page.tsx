...
// This block of const declarations was previously outside the component.
// Moving them inside, before the main return, but after activeRide is checked.
const {
  status,
  passengerName,
  pickupLocation,
...
// This return statement was missing, causing the content to be outside the component.
// Now, the constants above are defined if activeRide exists, and then this JSX is returned.
return (
