...
const slidesData: CarouselSlide[] = [
  {
    ...
    icon: Target,
    imageUrl: "https://placehold.co/600x300/A0B4E8/FFFFFF.png", 
  ...
  },
  {
    ...
    icon: Users,
    imageUrl: "https://placehold.co/600x300/A0D2DB/333333.png", 
  ...
  },
  {
    ...
    icon: ShieldCheck,
    imageUrl: "https://placehold.co/600x300/B4CFE8/333333.png", 
