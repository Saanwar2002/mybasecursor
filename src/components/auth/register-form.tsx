...
export function RegisterForm() {
  const { login } = useAuth(); // Using login for simplicity post-registration
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // Here, we're just "logging them in" immediately after.
    login(values.email, values.name, values.role as UserRole);
    toast({
